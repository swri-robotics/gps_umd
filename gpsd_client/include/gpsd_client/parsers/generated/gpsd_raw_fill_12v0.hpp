...
/// the same length.
template <typename T>
inline void fill_skyview(const T& in, gps_extended_msgs::msg::GPSDRaw12v0& out,
...
/// the same length.
template <typename T>
inline void fill_devices_list(const T& in, gps_extended_msgs::msg::GPSDRaw12v0& out,
                          const std::vector<std::size_t>& idx)
{
  (void)in;
  (void)out;
...
/// the same length.
template <typename T>
inline void fill_raw_meas(const T& in, gps_extended_msgs::msg::GPSDRaw12v0& out,
                          const std::vector<std::size_t>& idx)
{
  (void)in;
  (void)out;
...
/// the same length.
template <typename T>
inline void fill_imu(const T& in, gps_extended_msgs::msg::GPSDRaw12v0& out,
                          const std::vector<std::size_t>& idx)
{
  (void)in;
  (void)out;
