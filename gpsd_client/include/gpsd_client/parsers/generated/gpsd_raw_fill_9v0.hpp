...
#include <gps_msgs/msg/gpsd_fix9v0.hpp>
#include <gps_msgs/msg/gpsd_fix_ecef9v0.hpp>
...
template <typename T>
inline void fill(const T& in, gps_msgs::msg::GPSDFix9v0& out);
template <typename T>
inline void fill(const T& in, gps_msgs::msg::GPSDFixEcef9v0& out);
template <typename T>
inline void fill(const T& in, gps_msgs::msg::GPSDFixNED9v0& out);
template <typename T>
